...
# =============================================================================
    ...
    aut2arkButton = tk.Button(frame1, text = "Aligner ses données AUT ", command=lambda: aut2ark.formulaire_noticesaut2arkBnF(master,access_to_network,[0,False]), 
                              padx=25,pady=1, bg="#fefefe", font="Arial 8 normal")
    aut2arkButton.pack()
...
# =============================================================================
    tk.Label(frame2,text="Outils d'accompagnement",bg=couleur_fond,
             fg="#365B43",font="Arial 11 bold").pack(anchor="w")
    tk.Label(frame2,text="\n",bg=couleur_fond,font="Arial 4 normal").pack()
    
    tk.Label(frame2,text="Préparer ses données\n(constitution des tableaux à partir d'un export catalogue)",
             bg=couleur_fond,fg="#365B43",font="Arial 9 bold").pack(anchor="w")
    
    marc2tableButton = tk.Button(frame2, text = "Convertir un fichier Marc\n en tableaux", 
...
# =============================================================================
    ...
    tk.Label(frame2,text="Exporter les données BnF après alignement",bg=couleur_fond,fg="#365B43",font="Arial 9 bold").pack(anchor="w")

    ark2recordsButton = tk.Button(frame2, text = "Exporter une liste d'ARK BnF\n en notices", 
