    ...
    with open(entry_filename, 'rb') as fh:
        ...
        try:
            ...
            main.popup_errors(
                ...
                "https://github.com/Transition-bibliographique/bibliostratus/wiki/1-%5BBleu%5D-Pr%C3%A9parer-ses-donn%C3%A9es-pour-l'alignement-%C3%A0-partir-d'un-export-catalogue#un-probl%C3%A8me-dencodage--passez-en-xml-avec-marcedit"  # noqa
            )
...
def iso2tables(master, entry_filename, file_format, rec_format, id_traitement):
    ...
    (test_file, input_file) = test_encoding_file(
        master, entry_filename, encoding)
    assert test_file
