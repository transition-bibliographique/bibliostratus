...
python bibliostratus-cli.py --action bib2id --file main\examples\mon_impr.tsv --prefix cli_test

aut2id
python bibliostratus-cli.py --action aut2id --file main\examples\aut_align_aut.tsv

marc2tables
python bibliostratus-cli.py --action marc2tables --file main\examples\3bibrecords.xml --filetype xml-utf8 --recordtype bib --prefix cli_test

ark2records
*Export de notices BIB en XML + AUT liées
python bibliostratus-cli.py --action ark2records --file main\examples\listeARKbib.tsv --recordtype bib --colnum 1 --get_authors oui --output_format unimarc --output_file xml --encoding utf8 --dir main --prefix cli_test
*Export tabulé de BIB (zones 200 et 700)
python bibliostratus-cli.py --action ark2records --file main\examples\listeARKbib.tsv --recordtype bib --colnum 1 --output_format unimarc --output_file tab --fields 200$a;700 --dir main --prefix cli_test
