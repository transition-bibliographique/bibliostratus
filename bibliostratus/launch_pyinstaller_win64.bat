:: Préalable : lancer la compilation depuis l'environnement virtuel
...
If NOT "%version%"=="%Replaced%" (
    echo version RC
	copy ..\bin\bibliostratus_%version%_win64_py3.10.zip ..\bin\RC\bibliostratus_%version_bbs%_win64_py3.10.zip
